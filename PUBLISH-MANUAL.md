...
2. Fill in:
   - **Repository name:** `constrobill-pro` *(or any name you prefer)*
...
6. Refresh the page — you will see:
   > ✅ Your site is live at `https://YOUR-USERNAME.github.io/constrobill-pro`
...
## 🌐 Live App
**[Open ConstroBill Pro →](https://YOUR-USERNAME.github.io/constrobill-pro)**
...
4. Replace `YOUR-USERNAME` and `constrobill-pro` with your actual GitHub username and repo name
...
> If you want a professional URL like `constrobill.yourcompany.com` instead of `github.io`
...
2. Under **Custom domain**, enter: `constrobill.yourcompany.com`
3. Click **Save**
...
```
https://YOUR-USERNAME.github.io/constrobill-pro
```
...
| Item | Value |
|---|---|
| Your live URL | `https://YOUR-USERNAME.github.io/constrobill-pro` |
